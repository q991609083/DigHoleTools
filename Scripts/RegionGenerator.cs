...
public class RegionGenerator : MonoBehaviour
{
    ...
    private void CreatePlane()
    {
        ...
        BoxCollider rayRecvCollider = obj.AddComponent<BoxCollider>();
        rayRecvCollider.center = Vector3.zero;
        rayRecvCollider.size = new Vector3((float)(width - 2) * scale, (float)(height - 2) * scale - 0.32f,0.1f);
        obj.tag = "RecvRay";
        obj.layer = LayerMask.NameToLayer("RecvRay");
